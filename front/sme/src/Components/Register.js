            ...
            <table>
              <tr className='register-row'>
                <td>
                  ...
                  <TextField error={!firstname ? true : false} required id="outlined-basic" label="First Name" variant="outlined" onKeyUp={(e) => { setFirstname(e.target.value) }} />
                </td>
                <td>
                  <div className='register-category'>Last Name</div>
                  <TextField error={!lastname ? true : false} required id="outlined-basic" label="Last Name" variant="outlined" onKeyUp={(e) => { setLastname(e.target.value) }} />
                </td>
              </tr>
              <tr className='register-row'>
                <td>
                  <div className='register-category'>Branch</div>
                  <TextField error={!branch ? true : false} sx={{width: '28ch'}} required select id="outlined-select" label="Branch" variant="outlined" onClick={(e) => { setBranch(e.target.dataset.value) }}>
              ...
              <tr className='register-row'>
                <td>
                  ...
                  <TextField error={!username ? true : false} required id="outlined-basic" label="Username" variant="outlined" onKeyUp={(e) => {
              ...
              <tr className='register-row'>
                <td>
                  ...
                  <TextField error={!email ? true : false} required id="outlined-basic" label="E-mail" variant="outlined" helperText='DoD or Personal E-mail' onKeyUp={(e) => { setEmail(e.target.value) }} />
                </td>
                <td>
                  <div className='register-category'>Phone Number</div>
                  <TextField error={!phoneNumber ? true : false} required id="outlined-basic" label="Phone Number" variant="outlined" helperText='Provide valid 10 digit phone number' onKeyUp={(e) => { setPhoneNumber(e.target.value) }} />
                </td>
              </tr>
              <tr className='register-row'>
                <td>
                  <div className='register-category'>Supervisor's E-mail</div>
                  <TextField error={!supEmail ? true : false} required id="outlined-basic" label="Supervisor's E-mail" variant="outlined" onKeyUp={(e) => { setSupEmail(e.target.value) }} />
                </td>
                <td>
                  <div className='register-category'>Approver's E-mail</div>
                  <TextField error={!appEmail ? true : false} required id="outlined-basic" label="Approver's E-mail" variant="outlined" onKeyUp={(e) => { setAppEmail(e.target.value) }} />
                </td>
              </tr>
              <tr className='register-row'>
                      ...
                      <table>
                        <tr>
                          <td>
                            ...
                            <TextField error={!existingBaseName ? true : false} required select id="outlined-select" label="Select a base" variant="outlined" defaultValue={existingBaseName ? existingBaseName.name : ''} helperText="Please select a base or add one if it does not exist" onClick={(e) => { setExistingBaseName({ name: e.target.dataset.value, baseid: e.target.id }) }}>
                      ...
                      <table className='base-add-table' style={{ display: `${existingBaseName.name === '+ Add a new base' ? 'block' : 'none'}` }}>
                        <tr className='register-row'>
                          <td>
                            ...
                            <TextField error={!baseName ? true : false} required id="outlined-basic" label="Base Name" variant="outlined" defaultValue={baseName ? baseName : ''} onKeyUp={(e) => { setBaseName(e.target.value) }} />
                          </td>
                        </tr>
                        <tr className='register-row'>
                          <td>
                            <div className='register-category'>City</div>
                            <TextField error={!baseCity ? true : false} required id="outlined-basic" label="City" variant="outlined" defaultValue={baseCity ? baseCity : ''} onKeyUp={(e) => { setBaseCity(e.target.value) }} />
                          </td>
                        </tr>
                        <tr className='register-row'>
                          <td>
                            <div className='register-category'>State</div>
                            <TextField error={!baseState ? true : false} required select id="outlined-select" label="State" variant="outlined" defaultValue={baseState ? baseState : ''} helperText="Please select a state" onClick={(e) => { setBaseState(e.target.dataset.value) }}>
